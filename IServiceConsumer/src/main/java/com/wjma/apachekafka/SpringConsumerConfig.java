...
public class SpringConsumerConfig {
	...
	@Bean
	public ConsumerFactory<String, ServiceTxDTO> consumerFactory() {
		return new DefaultKafkaConsumerFactory<>(consumerConfigs());
	}

	@Bean
	public ConcurrentKafkaListenerContainerFactory<String, ServiceTxDTO> kafkaListenerContainerFactory() {
		ConcurrentKafkaListenerContainerFactory<String, ServiceTxDTO> factory = new ConcurrentKafkaListenerContainerFactory<>();
